...
def fill_mask_sentence():
    ...
    parser.add_argument("--pretrain_path", default= "./ChineseBERT-base/", required=True, type=str, help="pretrain model path")
    parser.add_argument("--sentence", default= "今天天气不错", required=True, type=str, help="input sentence")
