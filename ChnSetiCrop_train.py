...
from models.modeling_glycebert import GlyceBertForSequenceClassification,ImpGlyceBertForSequenceClassification
...
class ChnSentiClassificationTask(pl.LightningModule):
    ...
    def __init__(
        ...
        self.model = ImpGlyceBertForSequenceClassification.from_pretrained(self.bert_dir)

        self.loss_fn = CrossEntropyLoss()
        self.acc = torchmetrics.Accuracy(task = 'binary',num_classes=self.bert_config.num_labels)
